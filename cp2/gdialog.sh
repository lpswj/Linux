...
gdialog --tile "Questionnaire" --inputbox "Please enter your name" 9 30 2>_1.txt
Q_NAME=$(cat _1.txt)
...
if [ "$Q_MUSIC" = "1" ];then
		gdialog --tile "Likes Classical" --msgbox "Good choice!" 12 25
else
		gdialog --tile "Dosen't like Classical" --msgbox "Shame" 12 25
fi
